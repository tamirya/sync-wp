...
export function SupplierCategoriesClient({
  ...
  const selectedCategories = rootCategories.filter((c) => selectedIds.has(c.id));
          ...
          return (
            ...
            >
              ...
              <Link
                ...
                className="relative block h-28 w-full shrink-0 overflow-hidden bg-gradient-to-br from-sky-50 to-cyan-50"
              >
                {imgSrc ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center">
                    <svg
                      ...
                      stroke="currentColor"
                      strokeWidth="1.25"
                      className="h-10 w-10 text-cyan-300 transition-transform group-hover:scale-110"
                      aria-hidden
                    >
              ...
              <div className="flex flex-1 flex-col p-4">
                ...
                <div className="flex-1 space-y-2">
                  <Link
                    href={`/${locale}/suppliers/${supplierId}/categories/${cat.id}`}
                  >
                    <h3 className="truncate text-sm font-bold text-card-foreground transition-colors hover:text-primary">
                      {cat.name}
                    </h3>
                  </Link>
                ...
                {/* Select button — always pinned to bottom */}
                <button
              ...
              {selectedCategories.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    {total > 0 && (
                      <span className="text-primary/70">{formatTotal(total)}</span>
                    )}
                    <button
                      onClick={() => toggle(c.id)}
